                ...
                <div class="col-7">
                    ...
                    <div class="d-flex user-images" >
                        <div class="card mr-2" style="width: 12rem;">
                            ...
                            <div class="card-body">
                                <h5 class="card-title text-center">Poxosyan Poxos</h5>
                            </div>
                        </div>
                        <div class="card mr-2" style="width: 12rem;">
                            <img class="card-img-top" src="assets/avatar.png" alt="Card image cap">
                            <div class="card-body">
                                <h5 class="card-title text-center">Armenakyan Ashot</h5>
                            </div>
                        </div>
                        <div class="card" style="width: 12rem;">
                            <img class="card-img-top" src="assets/avatar.png" alt="Card image cap">
                            <div class="card-body">
                                <h5 class="card-title text-center">Manukyan Garnik</h5>
                            </div>
                        </div>
                    </div>
                </div>
